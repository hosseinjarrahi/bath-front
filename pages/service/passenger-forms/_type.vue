    ...
    <template #header-btn>
      <v-tooltip bottom>
        <template v-slot:activator="{ on, attrs }">
          <v-btn v-bind="attrs" v-on="on" small outlined class="ml-3" color="success" elevation="0" max-width="30px"
            max-height="30px" @click="_event('createBtnCustom')">
...
export default {
  ...
  beforeCreate() {
    ...
    this.$majra.init({
      ...
      mainRoute: { route: "/passenger-form?_with=serviceOptions" + query, key: 'PassengerForm' },
      relations: [
        { route: "/passenger", key: "Passenger" },
      ],
      fields: fields(this),
    });
  },
