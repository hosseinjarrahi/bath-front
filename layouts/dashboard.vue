<template>
  <v-app id="inspire-4" :class="$vuetify.rtl ? 'set-iransas' : 'set-avenir'">
    <NavigationDrawer :mini="mini" :right-drawer="rightDrawer" :dashboard-items="dashboardItems"
      @changeRightDrawer="rightDrawer = $event" />

    <AppBar :right-drawer="rightDrawer" :mini="mini" @changeMini="mini = $event"
      @changeRightDrawer="rightDrawer = $event" />

    <v-main class="mx-3 mx-sm-5 mx-md-5 mx-lg-8 mt-6">
      <div class="px-xs-0 px-lg-16">
...
import ContextMenuPro from '~/components/utilities/ContextMenuPro.vue'
...
#__layout #navigation .theme--light.v-list-item:not(.v-list-item--active):not(.v-list-item--disabled) {
...
/* end */
/* for combobox size  */
.mamad-combo .v-select.v-select--chips:not(.v-text-field--single-line).v-text-field--box.v-input--dense .v-select__selections,
...
#navigation .theme--light.v-list-item:not(.v-list-item--active):not(.v-list-item--disabled) {
  color: antiquewhite !important;
}

#navigation .mr-2.v-list-item--active.v-list-item.v-list-item--link.theme--light {
